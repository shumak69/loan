...
/*#__PURE__*/
function () {
  function Difference(oldEdu, newEdu, items) {
  ...
  _createClass(Difference, [{
    key: "bindBtns",
    value: function bindBtns(edu, items, counter) {
      edu.querySelector('.plus').addEventListener('click', function () {
...
/*#__PURE__*/
function () {
  function VideoPlayer(btns, overlay) {
    ...
    value: function bindTriggers() {
      ...
      this.btns.forEach(function (item) {
        item.addEventListener('click', function () {
          ...
          _this.createPlayer(item.getAttribute('data-url'));
        });
      });
    }
  }, {
  ...
  _createClass(MainSlider, [{
    ...
    value: function showSlides() {
      ...
      if (this.slideIndex != 2) {
        ...
        setTimeout(function () {
          _this.man.style.display = 'block';

          _this.man.classList.add('animate__animated', 'animate__zoomIn');
        }, 3000);
      }
